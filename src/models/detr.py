"""
DETR (Detection Transformer) via Hugging Face Transformers.
...
def run(video_path: str, gt_binary: list, conf_threshold: float = 0.5, skip_frames: int = 1) -> dict:
    ...
    print("  Carregando DETR (facebook/detr-resnet-50)...")
    ...
    cap.release()
    return compute_metrics(gt_binary, preds, frame_times, confidences, "DETR")
