...
def main():
    ...
    # Conditional DETR: melhora a convergência do DETR original condicionando
    # as queries de atenção espacialmente; carregado do HuggingFace Hub
    ...
    while True:
        ...
        cv2.imshow("Conditional DETR — Deteccao", annotated)
