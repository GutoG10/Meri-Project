...
def main():
    ...
    # FCOS (Fully Convolutional One-Stage): detector anchor-free com ResNet-50 + FPN,
    # que prediz objetos diretamente por localização no mapa de features sem âncoras fixas
    ...
    while True:
        ...
        cv2.imshow("FCOS — Deteccao", annotated)
