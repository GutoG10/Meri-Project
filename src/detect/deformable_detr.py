...
def main():
    ...
    # Deformable DETR: extensão do DETR que usa atenção deformável para ser mais eficiente
    # em objetos de múltiplas escalas; carregado do HuggingFace Hub
    ...
    while True:
        ...
        cv2.imshow("Deformable DETR — Deteccao", annotated)
